...
```Bash
wget https://github.com/CRBS/cdeep3m/archive/v1.6.1rc1.tar.gz
```

#### Step 2) Uncompress 

```Bash
tar -zxf v1.6.1rc1.tar.gz
cd cdeep3m-1.6.1rc1
```
