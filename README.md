...
[![Launch Deep3m AWS CloudFormation link](https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png)](https://console.aws.amazon.com/cloudformation/home?region=us-west-2#/stacks/new?stackName=cdeep3m-stack-0-20-0rc2&templateURL=https://s3-us-west-2.amazonaws.com/cdeep3m-releases/0.20.0rc2/cdeep3m_0.20.0rc2_basic_cloudformation.json)
...
```Bash
wget https://github.com/CRBS/cdeep3m/releases/download/v0.20.0rc2/cdeep3m-0.20.0rc2.tar.gz
```

#### Step 2) Uncompress 

```Bash
tar -zxf cdeep3m-0.20.0rc2.tar.gz
cd cdeep3m-0.20.0rc2
```
