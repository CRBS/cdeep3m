...
release: dist ## package and upload a release to s3
	...
	@vers=`cat VERSION` ; \
	tarfile=deep3m-v$${vers}.tar.gz ;\
	cloudform=deep3m_v$${vers}_basic_cloudformation.json ;\
...
dist: clean ## builds source and wheel package
	...
	cp -a model $$distdir/. ;\
        cp VERSION $$distdir/. ;\
        cat aws/basic_cloudformation.json | sed "s/@@VERSION@@/$${vers}/g" > dist/deep3m_v$${vers}_basic_cloudformation.json ;\
