...
@test "run_all_predict.sh success no args 1 package in each model dir" {
    ...
    [ "${lines[2]}" = "Image Dir: $TEST_TMP_DIR/augimage" ]
    [ "${lines[3]}" = "Running 1fm predict 1 package(s) to process" ]
    [ "${lines[4]}" = "  Processing Pkg001_Z01 1 of 1 $TEST_TMP_DIR/tmodel/1fm/trainedmodel $TEST_TMP_DIR/augimage/Pkg001_Z01 0 $TEST_TMP_DIR/1fm/Pkg001_Z01" ]
    [ "${lines[8]}" = "Running 3fm predict 1 package(s) to process" ]
    [ "${lines[9]}" = "  Processing Pkg002_Z01 1 of 1 $TEST_TMP_DIR/tmodel/3fm/trainedmodel $TEST_TMP_DIR/augimage/Pkg002_Z01 0 $TEST_TMP_DIR/3fm/Pkg002_Z01" ]
    [ "${lines[13]}" = "Running 5fm predict 1 package(s) to process" ]
    [ "${lines[14]}" = "  Processing Pkg002_Z01 1 of 1 $TEST_TMP_DIR/tmodel/5fm/trainedmodel $TEST_TMP_DIR/augimage/Pkg002_Z01 0 $TEST_TMP_DIR/5fm/Pkg002_Z01" ]
...
@test "run_all_predict.sh success --gpu 1 set" {
    ...
    [ "${lines[2]}" = "Image Dir: $TEST_TMP_DIR/augimage" ]
    [ "${lines[3]}" = "Running 1fm predict 1 package(s) to process" ]
    [ "${lines[4]}" = "  Processing Pkg001_Z01 1 of 1 $TEST_TMP_DIR/tmodel/1fm/trainedmodel $TEST_TMP_DIR/augimage/Pkg001_Z01 1 $TEST_TMP_DIR/1fm/Pkg001_Z01" ]
    [ "${lines[8]}" = "Running 3fm predict 1 package(s) to process" ]
    [ "${lines[9]}" = "  Processing Pkg002_Z01 1 of 1 $TEST_TMP_DIR/tmodel/3fm/trainedmodel $TEST_TMP_DIR/augimage/Pkg002_Z01 1 $TEST_TMP_DIR/3fm/Pkg002_Z01" ]
    [ "${lines[13]}" = "Running 5fm predict 1 package(s) to process" ]
    [ "${lines[14]}" = "  Processing Pkg002_Z01 1 of 1 $TEST_TMP_DIR/tmodel/5fm/trainedmodel $TEST_TMP_DIR/augimage/Pkg002_Z01 1 $TEST_TMP_DIR/5fm/Pkg002_Z01" ]
    [ "${lines[18]}" = "Prediction has completed. Have a nice day!" ]
    [ -f "$TEST_TMP_DIR/1fm/Pkg001_Z01/DONE" ]
    [ -f "$TEST_TMP_DIR/3fm/Pkg002_Z01/DONE" ]
    [ -f "$TEST_TMP_DIR/5fm/Pkg002_Z01/DONE" ]
